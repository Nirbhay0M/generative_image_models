...
""""
Adaptation of Eric Jan's implementation of DRAW in TensorFlow
...
tf.flags.DEFINE_string("data_dir", "./tmp/SVHN", "")
...
#--- Stochastic data generation graph
# DO_SHARE = True
cs_gen=[0]*T # sequence of canvases
...
for t in range(T):
    c_prev_gen = tf.zeros((batch_size,img_size)) if t==0 else cs[t-1]
    z_gen=e[t]
...
if not FLAGS.restore and not FLAGS.force_restore:
