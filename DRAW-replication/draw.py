...
## BUILD MODEL ## 
# e_var = [0]*e_test_size
e_fixed = tf.random_normal((z_size), mean=0, stddev=1, seed=local_seed)
# # for i in range(e_test_size):
# for i in range(T):
#     e_var[i] = tf.random_normal((batch_size,z_size), mean=0, stddev=0)
...
for t in range(T):
    ...
    z_evar=e_fixed if t == 0 else e[t]
